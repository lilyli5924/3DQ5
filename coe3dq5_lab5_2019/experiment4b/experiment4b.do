...
vlog -sv -work rtl_work +define+DISABLE_DEFAULT_NET experiment4b.v
vlog -sv -work rtl_work +define+DISABLE_DEFAULT_NET tb_experiment4b.v

# specify library for simulation
vsim -t 100ps -L altera_mf_ver -lib rtl_work tb_experiment4b
